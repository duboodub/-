...
def file_path_of_xlsx(excel_path, file_nm):
    dir_of_excel = excel_path + '/excel_copied_from_tdms/'
    if not os.path.exists(dir_of_excel):
        print('dir_of_excel doesn\'t exist, a new one created!\n')
        os.makedirs(dir_of_excel)
        
    file_path_of_xlsx = dir_of_excel + file_nm + '.xlsx'
...
if __name__ == '__main__':
    ...
    folder_path = r'E:\NAS, data\Data Temporary\Cryostat B\DUBO\DB20211129f1, LCO-LSMO0.67, RHzT'
